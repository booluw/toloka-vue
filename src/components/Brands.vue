<script setup></script>
<template>
  <section class="py-5 px-5 md:px-20 bg-primary/5 flex flex-col md:flex-row justify-center items-center md:gap-5">
    <h3 class="text-2xl text-primary font-bold flex-shrink-0">Trusted by:</h3>
