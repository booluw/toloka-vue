<script setup></script>
<template>
  <main class="h-screen overflow-hidden flex items-center justify-center bg-primary">
    <section class="bg-white rounded-2xl p-5 md:p-10 md:w-1/3">
      ...
      <el-form label-position="top">
        ...
        <el-form-item label="Password">
          <el-input size="large" v-model="input2" type="password" placeholder="Password" />
        </el-form-item>

        <el-button class="!bg-primary/90 !border-primary w-full" type="primary" size="large"
          >Login</el-button
        >
